                        ...
                        <transition name="fade">
                            <div
                                ...
                                <Link
                                    ...
                                    <span class="ml-2 whitespace-nowrap">Aerolíneas</span>
                                </Link>
                            </div>
                            ...
                            <ul
                                ...
                                <li
                                    ...
                                    title="Tours">
                                    <FontAwesomeIcon :icon="faRoute" class="fa-shadow"/>
                                ...
                                <li
                                    ...
                                    title="Otros">
                                    <FontAwesomeIcon :icon="faPlaneDeparture" class="fa-shadow"/>
                                    <span class="ml-3">Aerolíneas</span>
                                </li>
                            </ul>
                        </transition>
                    </li>
