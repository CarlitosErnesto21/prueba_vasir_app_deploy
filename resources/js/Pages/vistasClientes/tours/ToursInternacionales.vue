...
// URL específica para tours internacionales
const URL_API = "/api/tours?categoria=internacional"

// Configuración específica para tours internacionales
const TITULO = "Tours Internacionales"
const DESCRIPCION = "Explora destinos increíbles alrededor del mundo"
const TIPO_TOUR = "internacional"
</script>

<template>
  <Head title="Tours Internacionales" />
